    ...
    return (
      <div>
        ...
        <div className='privacy'>
          ...
          <p>{'If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at hillarywylie@madisonmckinley.us or mailing us at: Madison McKinley 2311 Cedar Springs Road Suite 350, Dallas , TX, 75201, United States'}</p>
          ...
          <p>{'If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at sales@madisonmckinley.us or by mail at Madison McKinley'}</p>
          <p>{'[Re: Privacy Compliance Officer]'}</p>
          <p>{'[2311 Cedar Springs Road Suite 350, Dallas , TX, 75201, United States]'}</p>
        </div>
        <Footer
        show={true} />
      </div>
...
export default connect(null, {fetchCart})(Privacy)
